...
const Cart2 = ({ data }) => {
  ...
  return (
    <Link to='/productDetails'
      ...
      className="flex-shrink-0 w-[20%] snap-start cursor-pointer group aspect-[228/347]  rounded-xl relative overflow-hidden border border-BorderColor hover:border-MainColor"
    >
