...
const ForYouProductsPage = () => {
  ...
  return (
    ...
    <div className="">
      ...
      <div className="container mx-auto mt-4 p-1 lg:p-0">
        <h2 className="text-TextColor">Total Products: {products?.length}</h2>

        <div className="mt-4 ">
          <div className="grid 2xl:grid-cols-6 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 gap-2">
            {products ? (
              products.length > 0 ? (
                currentProducts.map((product) => (
                  <ProductCart
              ...
              array.map((product) => (
                <Box key={product} padding="6" boxShadow="lg" bg="#FAD7A0">
                  <Skeleton height="200px" />
                  <SkeletonText
                    mt="4"
                    noOfLines={3}
